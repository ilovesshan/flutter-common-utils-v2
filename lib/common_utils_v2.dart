...
export 'package:flutter_scankit/flutter_scankit.dart' hide ScanResult;
...
export 'package:flutter_localized_locales/flutter_localized_locales.dart';
...
/// 解决export文件冲突
export 'src/conflict/conflict.dart' hide NotifyManager;
