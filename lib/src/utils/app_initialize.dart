...
class AppInitialize {
  ...
  static Iterable<LocalizationsDelegate<dynamic>> internationalization() {
    Iterable<LocalizationsDelegate<dynamic>> iterable = [GlobalCupertinoLocalizations.delegate, GlobalMaterialLocalizations.delegate, GlobalWidgetsLocalizations.delegate];
    return iterable;
  }
